define([
	...
	"text!example_staticBranchingData", "text!example_staticBranchingConfig",], function(Display, StoryDisplay, State, ChunkLibrary, Wishlist, StoryAssembler, Templates, Character, Hanson, 
		example_staticBranchingData, example_staticBranchingConfig) {
	...
	var settings = {
		...
		"sceneOrder" : ["example-staticBranching"]			//progression of scenes when you hit "Begin", or laid out in timeline
	}
